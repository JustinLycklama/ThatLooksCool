...
class ViewCategoryItemsViewController: AdViewController {
...
//        stack.addArrangedSubview(mapView)
    ...
    private func createItemsView() -> UIView {
        ...
        itemsViewController.canAddItems = true
...
extension ViewCategoryItemsViewController: ItemSelectionDelegate {
...
extension ViewCategoryItemsViewController: CompletableActionDelegate {
    func complete() {
