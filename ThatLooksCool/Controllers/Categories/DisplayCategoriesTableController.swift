...
protocol CompletableWithCategoryDelegate: AnyObject {
    func complete(withCategory category: ItemCategory?)
}

class DisplayCategoriesTableController: UIViewController {
    
    weak var delegate: CompletableWithCategoryDelegate?
