...
public protocol CategorySelectionDelegate: AnyObject {
    func editCategory(_ category: ItemCategory?)
    func selectCategory(_ category: ItemCategory)
}

public class CategoriesTableController: AddableSectionTableController {

    struct Constants {
        static let categoryCell = "CategoryCell"
    }
    
    public weak var delegate: CategorySelectionDelegate?
